...
const socialLinks = [
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        />
        <path
          d="M13 7H11.5C10.6716 7 10 7.67157 10 8.5V18"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        />
  ...
  },
  {
    ...
    icon: (
      <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        />
        <path
          d="M10 13V10.5C10 9.67157 10.6716 9 11.5 9C12.3284 9 13 9.67157 13 10.5V13"
          stroke="currentColor"
          strokeWidth="1.5"
          strokeLinecap="round"
        ...
        <div className={styles.content}>
          ...
          <div className={styles.brand}>
            ...
            <p className={styles.tagline}>
              Revolutionizing productivity through gamification. Work hard, get
              rewarded.
            </p>
